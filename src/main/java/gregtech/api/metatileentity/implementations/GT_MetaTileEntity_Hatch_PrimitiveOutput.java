...
import gregtech.common.gui.GT_Container_PrimitiveOutputHatch;
import gregtech.common.gui.GT_GUIContainer_PrimitiveOutputHatch;
...
public class GT_MetaTileEntity_Hatch_PrimitiveOutput extends GT_MetaTileEntity_Hatch {
    private String lockedFluidName = null;
    private EntityPlayer playerThatLockedfluid = null;
    public byte mMode = 0;

    public GT_MetaTileEntity_Hatch_PrimitiveOutput(int aID, String aName, String aNameRegional, int aTier) {
    ...
    public GT_MetaTileEntity_Hatch_PrimitiveOutput(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Hatch_PrimitiveOutput(mName, mTier, mDescriptionArray, mTextures);
    }
    ...
    public Object getServerGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_Container_PrimitiveOutputHatch(aPlayerInventory, aBaseMetaTileEntity);
    }

    @Override
    public Object getClientGUI(int aID, InventoryPlayer aPlayerInventory, IGregTechTileEntity aBaseMetaTileEntity) {
        return new GT_GUIContainer_PrimitiveOutputHatch(aPlayerInventory, aBaseMetaTileEntity, getLocalName());
    }
