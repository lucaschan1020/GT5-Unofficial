...
//		checkCellBalance();
    ...
    public static class GT_Recipe_Map {
        ...
        public static final GT_Recipe_Map sCokeOvenRecipes = new GT_Recipe_Map(new HashSet<>(150), "gt.recipe.primitivecokeoven", "Coke Oven", null, RES_PATH_GUI + "basicmachines/Default", 1, 1, 1, 0, 1, E, 1, E, true, true);
