...
public class GT_Container_PrimitiveOutputHatch extends GT_Container_BasicTank {

    public GT_Container_PrimitiveOutputHatch(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity) {
    ...
    public ItemStack slotClick(int aSlotIndex, int aMouseclick, int aShifthold, EntityPlayer aPlayer) {
        if (aSlotIndex == 3 && aMouseclick < 2) {
            GT_MetaTileEntity_Hatch_PrimitiveOutput tHatch = (GT_MetaTileEntity_Hatch_PrimitiveOutput) mTileEntity.getMetaTileEntity();
