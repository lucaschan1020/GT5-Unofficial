...
public class GT_GUIContainer_PrimitiveOutputHatch extends GT_GUIContainerMetaTile_Machine implements INEIGuiHandler {

    private final String mName;

    public GT_GUIContainer_PrimitiveOutputHatch(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, String aName) {
        super(new GT_Container_PrimitiveOutputHatch(aInventoryPlayer, aTileEntity), RES_PATH_GUI + "OutputHatch.png");
        mName = aName;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (mContainer != null) {
            ...
            fontRendererObj.drawString(GT_Utility.parseNumberToString(((GT_Container_PrimitiveOutputHatch) mContainer).mContent), 10, 30, 16448255);
